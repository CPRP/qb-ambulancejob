...
CreateThread(function()
    lsfdBlip = AddBlipForCoord(-660.42, -77.13, 38.8, 15.25)
    SetBlipSprite(lsfdBlip, 60)
    SetBlipScale(lsfdBlip, 0.8)
    SetBlipDisplay(lsfdBlip, 4)
    SetBlipColour(lsfdBlip, 1)
    SetBlipAsShortRange(lsfdBlip, true)
    BeginTextCommandSetBlipName("STRING")
    AddTextComponentSubstringPlayerName("Los Santos Fire Department")
    EndTextCommandSetBlipName(lsfdBlip)
end)

-- CreateThread(function()
--     medusaBlip = AddBlipForCoord(756.53, -557.88, 33.64)
--     SetBlipSprite(medusaBlip, 614)
--     SetBlipScale(medusaBlip, 0.8)
--     SetBlipDisplay(medusaBlip, 4)
--     SetBlipColour(medusaBlip, 50)
--     SetBlipAsShortRange(medusaBlip, true)
--     BeginTextCommandSetBlipName("STRING")
--     AddTextComponentSubstringPlayerName("Medusa Nightclub")
--     EndTextCommandSetBlipName(medusaBlip)
-- end)
...
--     SetBlipSprite(townhallBlip, 176)
--     SetBlipScale(townhallBlip, 0.8)
--     SetBlipDisplay(townhallBlip, 4)
--     SetBlipColour(townhallBlip, 0)
--     SetBlipAsShortRange(townhallBlip, true)
--     BeginTextCommandSetBlipName("STRING")
--     AddTextComponentSubstringPlayerName("Townhall")
--     EndTextCommandSetBlipName(townhallBlip)
-- end)

-- CreateThread(function()
--     ottosBlip = AddBlipForCoord(810.02, -812.16, 26.18)
--     SetBlipSprite(ottosBlip, 402)
--     SetBlipScale(ottosBlip, 0.8)
--     SetBlipDisplay(ottosBlip, 4)
--     SetBlipColour(ottosBlip, 4)
--     SetBlipAsShortRange(ottosBlip, true)
--     BeginTextCommandSetBlipName("STRING")
--     AddTextComponentSubstringPlayerName("Otto's Autos")
...
CreateThread(function()
    ...
    SetBlipSprite(recordaBlip, 614)
    SetBlipScale(recordaBlip, 0.8)
    SetBlipDisplay(recordaBlip, 4)
    SetBlipColour(recordaBlip, 31)
    SetBlipAsShortRange(recordaBlip, true)
    BeginTextCommandSetBlipName("STRING")
    AddTextComponentSubstringPlayerName("Record A Studio")
    EndTextCommandSetBlipName(recordaBlip)
end)

-- CreateThread(function()
--     davisfsBlip = AddBlipForCoord(217.2, -1636.09, 30.44)
--     SetBlipSprite(davisfsBlip, 60)
--     SetBlipScale(davisfsBlip, 0.8)
--     SetBlipDisplay(davisfsBlip, 4)
--     SetBlipColour(davisfsBlip, 1)
--     SetBlipAsShortRange(davisfsBlip, true)
--     BeginTextCommandSetBlipName("STRING")
--     AddTextComponentSubstringPlayerName("Davis Fire Station")
--     EndTextCommandSetBlipName(davisfsBlip)
-- end)

CreateThread(function()
    elburrofsBlip = AddBlipForCoord(1197.553, -1454.430, 34.958)
    SetBlipSprite(elburrofsBlip, 60)
    SetBlipScale(elburrofsBlip, 0.8)
    SetBlipDisplay(elburrofsBlip, 4)
    SetBlipColour(elburrofsBlip, 1)
    SetBlipAsShortRange(elburrofsBlip, true)
    BeginTextCommandSetBlipName("STRING")
    AddTextComponentSubstringPlayerName("El Burro Heights Fire Station")
    EndTextCommandSetBlipName(elburrofsBlip)
end)

-- CreateThread(function()
--     uwuBlip = AddBlipForCoord(-580.862, -1079.083, 22.330)
--     SetBlipSprite(uwuBlip, 463)
--     SetBlipScale(uwuBlip, 0.8)
--     SetBlipDisplay(uwuBlip, 4)
--     SetBlipColour(uwuBlip, 8)
--     SetBlipAsShortRange(uwuBlip, true)
--     BeginTextCommandSetBlipName("STRING")
--     AddTextComponentSubstringPlayerName("UwU Cafe")
--     EndTextCommandSetBlipName(uwuBlip)
-- end)

-- CreateThread(function()
--     pizzaBlip = AddBlipForCoord(793.89, -758.22, 26.78)
--     SetBlipSprite(pizzaBlip, 304)
--     SetBlipScale(pizzaBlip, 0.8)
--     SetBlipDisplay(pizzaBlip, 4)
--     SetBlipColour(pizzaBlip, 17)
--     SetBlipAsShortRange(pizzaBlip, true)
--     BeginTextCommandSetBlipName("STRING")
--     AddTextComponentSubstringPlayerName("Pizza This Pizzaria")
--     EndTextCommandSetBlipName(pizzaBlip)
-- end)

CreateThread(function()
    bowlingBlip = AddBlipForCoord(758.88, -777.79, 26.45)
    SetBlipSprite(bowlingBlip, 270)
    SetBlipScale(bowlingBlip, 0.8)
    SetBlipDisplay(bowlingBlip, 4)
    SetBlipColour(bowlingBlip, 2)
    SetBlipAsShortRange(bowlingBlip, true)
    BeginTextCommandSetBlipName("STRING")
    AddTextComponentSubstringPlayerName("Bob's Balls Bowling Alley")
    EndTextCommandSetBlipName(bowlingBlip)
end)

CreateThread(function()
    recordBlip = AddBlipForCoord(-827.94, -698.45, 28.06)
    SetBlipSprite(recordBlip, 614)
    SetBlipScale(recordBlip, 0.8)
    SetBlipDisplay(recordBlip, 4)
    SetBlipColour(recordBlip, 1)
    SetBlipAsShortRange(recordBlip, true)
    BeginTextCommandSetBlipName("STRING")
    AddTextComponentSubstringPlayerName("Triad Record")
    EndTextCommandSetBlipName(recordBlip)
end)

-- CreateThread(function()
--     popsBlip = AddBlipForCoord(1583.62, 6453.38, 25.32)
--     SetBlipSprite(popsBlip, 621)
--     SetBlipScale(popsBlip, 0.8)
--     SetBlipDisplay(popsBlip, 4)
--     SetBlipColour(popsBlip, 2)
--     SetBlipAsShortRange(popsBlip, true)
--     BeginTextCommandSetBlipName("STRING")
--     AddTextComponentSubstringPlayerName("Pop's Diner")
--     EndTextCommandSetBlipName(popsBlip)
-- end)

CreateThread(function()
    rangerBlip = AddBlipForCoord(388.640, 787.820, 187.474)
    SetBlipSprite(rangerBlip, 141)
    SetBlipScale(rangerBlip, 0.8)
    SetBlipDisplay(rangerBlip, 4)
    SetBlipColour(rangerBlip, 31)
    SetBlipAsShortRange(rangerBlip, true)
    BeginTextCommandSetBlipName("STRING")
    AddTextComponentSubstringPlayerName("Park Ranger")
    EndTextCommandSetBlipName(rangerBlip)
end)

CreateThread(function()
    arcadeBlip = AddBlipForCoord(-1648.761, -1084.628, 13.156)
    SetBlipSprite(arcadeBlip, 103)
    SetBlipScale(arcadeBlip, 0.8)
    SetBlipDisplay(arcadeBlip, 4)
    SetBlipColour(arcadeBlip, 11)
...
-- CreateThread(function()
--     importsBlip = AddBlipForCoord(946.637, -990.316, 39.228)
--     SetBlipSprite(importsBlip, 402)
--     SetBlipScale(importsBlip, 0.8)
--     SetBlipDisplay(importsBlip, 4)
--     SetBlipColour(importsBlip, 40)
--     SetBlipAsShortRange(importsBlip, true)
--     BeginTextCommandSetBlipName("STRING")
--     AddTextComponentSubstringPlayerName("Imports Autoshop")
--     EndTextCommandSetBlipName(importsBlip)
-- end)

CreateThread(function()
    motelBlip = AddBlipForCoord(322.33, -218.83, 54.09)
    SetBlipSprite(motelBlip, 40)
    SetBlipScale(motelBlip, 0.8)
    SetBlipDisplay(motelBlip, 4)
    SetBlipColour(motelBlip, 8)
    SetBlipAsShortRange(motelBlip, true)
    BeginTextCommandSetBlipName("STRING")
    AddTextComponentSubstringPlayerName("Pink Cage Motel")
...
CreateThread(function()
    paletofsBlip = AddBlipForCoord(-386.76, 6108.09, 31.38)
    SetBlipSprite(paletofsBlip, 60)
    SetBlipScale(paletofsBlip, 0.8)
    SetBlipDisplay(paletofsBlip, 4)
    SetBlipColour(paletofsBlip, 1)
    SetBlipAsShortRange(paletofsBlip, true)
    BeginTextCommandSetBlipName("STRING")
    AddTextComponentSubstringPlayerName("Davis Fire Station")
    EndTextCommandSetBlipName(paletofsBlip)
end)

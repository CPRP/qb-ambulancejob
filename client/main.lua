...
CreateThread(function()
    leoboat1 = AddBlipForCoord(1576.67, 3908.41, 31.63)
    SetBlipSprite(leoboat1, 427)
    SetBlipScale(leoboat1, 0.8)
    SetBlipDisplay(leoboat1, 4)
    SetBlipColour(leoboat1, 38)
    SetBlipAsShortRange(leoboat1, true)
    BeginTextCommandSetBlipName("STRING")
    AddTextComponentSubstringPlayerName("BCSO Boat")
    EndTextCommandSetBlipName(leoboat1)
end)

CreateThread(function()
    leoboat2 = AddBlipForCoord(1338.8, 4270.16, 31.5)
    SetBlipSprite(leoboat2, 427)
    SetBlipScale(leoboat2, 0.8)
    SetBlipDisplay(leoboat2, 4)
    SetBlipColour(leoboat2, 38)
    SetBlipAsShortRange(leoboat2, true)
    BeginTextCommandSetBlipName("STRING")
    AddTextComponentSubstringPlayerName("BCSO Boat")
    EndTextCommandSetBlipName(leoboat2)
end)

CreateThread(function()
    leoboat3 = AddBlipForCoord(-273.81, 6604.74, 1.77)
    SetBlipSprite(leoboat3, 427)
    SetBlipScale(leoboat3, 0.8)
    SetBlipDisplay(leoboat3, 4)
    SetBlipColour(leoboat3, 38)
    SetBlipAsShortRange(leoboat3, true)
    BeginTextCommandSetBlipName("STRING")
    AddTextComponentSubstringPlayerName("BCSO Boat")
    EndTextCommandSetBlipName(leoboat3)
end)

CreateThread(function()
    leoboat8 = AddBlipForCoord(3859.45, 4458.94, 1.83)
    SetBlipSprite(leoboat8, 427)
    SetBlipScale(leoboat8, 0.8)
    SetBlipDisplay(leoboat8, 4)
    SetBlipColour(leoboat8, 38)
    SetBlipAsShortRange(leoboat8, true)
    BeginTextCommandSetBlipName("STRING")
    AddTextComponentSubstringPlayerName("BCSO Boat")
    EndTextCommandSetBlipName(leoboat8)
end)

CreateThread(function()
    leoboat4 = AddBlipForCoord(-785.16, -1490.49, 1.6)
    SetBlipSprite(leoboat4, 427)
    SetBlipScale(leoboat4, 0.8)
    SetBlipDisplay(leoboat4, 4)
    SetBlipColour(leoboat4, 38)
    SetBlipAsShortRange(leoboat4, true)
    BeginTextCommandSetBlipName("STRING")
    AddTextComponentSubstringPlayerName("LSPD Boat")
    EndTextCommandSetBlipName(leoboat4)
end)

CreateThread(function()
    leoboat7 = AddBlipForCoord(-3305.99, 959.05, 2.04)
    SetBlipSprite(leoboat7, 427)
    SetBlipScale(leoboat7, 0.8)
    SetBlipDisplay(leoboat7, 4)
    SetBlipColour(leoboat7, 38)
    SetBlipAsShortRange(leoboat7, true)
    BeginTextCommandSetBlipName("STRING")
    AddTextComponentSubstringPlayerName("LSPD Boat")
    EndTextCommandSetBlipName(leoboat7)
end)

CreateThread(function()
    leoboat5 = AddBlipForCoord(-186.92, 787.29, 198.11)
    SetBlipSprite(leoboat5, 427)
    SetBlipScale(leoboat5, 0.8)
    SetBlipDisplay(leoboat5, 4)
    SetBlipColour(leoboat5, 38)
    SetBlipAsShortRange(leoboat5, true)
    BeginTextCommandSetBlipName("STRING")
    AddTextComponentSubstringPlayerName("SAPR Boat")
    EndTextCommandSetBlipName(leoboat5)
end)

CreateThread(function()
    leoboat6 = AddBlipForCoord(-150.86, 3905.2, 31.69)
    SetBlipSprite(leoboat6, 427)
    SetBlipScale(leoboat6, 0.8)
    SetBlipDisplay(leoboat6, 4)
    SetBlipColour(leoboat6, 38)
    SetBlipAsShortRange(leoboat6, true)
    BeginTextCommandSetBlipName("STRING")
    AddTextComponentSubstringPlayerName("SAPR Boat")
    EndTextCommandSetBlipName(leoboat6)
end)

Citizen.CreateThread(function()     --[[PREVENTS HATS/GLASSES/ETC FROM FALLING OFF]]
    while true do
